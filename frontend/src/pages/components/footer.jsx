...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-customPurpple900T p-8 relative">
      <div className="w-1/2 bg-customPurpple100 absolute -top-20 left-0 h-[20rem] -z-10 blur-3xl rounded-3xl moving-element"></div>
      <div className="w-[85vw] mx-auto grid gap-8 grid-cols-1 md:grid-cols-4 place-items-center">
        <img src={logoCocha} alt="Logo" className="h-24 " />
        ...
        <div className="flex flex-wrap text-2xl w-full col-span-1 md:col-span-4 justify-center items-center gap-4 mt-4 md:mt-0">
          ...
          <a
            href="https://www.facebook.com/gamcochabamba"
            target="_blank"
          ...
          <a
            href="https://www.instagram.com/cochabambaciudad/"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <a
            href="https://www.tiktok.com/@alcaldiadecochabamba?lang=es"
            target="_blank"
            rel="noopener noreferrer"
          >
